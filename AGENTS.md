...
Not all 39 constraints carry equal weight.

- **Tier 1** (C1, C9, C15, C21, C23, C24, C26, C34, C37): Single match flags the piece. Always rewrite. C15 (em dashes) and C37 (uniform hyphenation across compound modifiers) are the two most visible structural tells in 2026; em-dash count must not exceed word_count/500.
- **Tier 2** (C3, C4, C10, C12, C28, C32, C33, C36, C38): One instance may pass. Two is a pattern.
